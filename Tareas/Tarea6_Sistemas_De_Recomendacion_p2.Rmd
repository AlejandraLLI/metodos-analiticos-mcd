...
El error de entrenamiento es de `r error_entrena` y el error de validación es de `r error_valida`. El error de validación es un poco más grande que el de entrenamiento (diferencia de `r error_valida-error_entrena`). 
