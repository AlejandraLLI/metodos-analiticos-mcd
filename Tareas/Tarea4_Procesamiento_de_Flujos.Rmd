...
* Si $i>n_0$ entonces se selecciona para ser parte de la muestra con probabilidad $k/n$. 

* Si $i\leq n0$ la probabilidad de que ya esté en la muestra es $k/n_0$ y es necesario que no sea seleccionado para ser eliminado $1-\tfrac{1}{k}=\tfrac{k-1}{k}$ i.e. la probabilidad de mantenerse en la muestra es $\tfrac{k}{n_0}\tfrac{k-1}{k}$
