...
Si queremos seleccionar un $1\%$ de las transacciones para hacer más rápido nuestro cálculo, podemos seleccionar al azar, para cada elemento, si lo incluímos en la muestra o no, por ejemplo:
...
# Funciones hash a utilizar con modulo 11 para tener una cubeta por no. de bits. 
...
Antes de seguir, hacemos la siguiente observación: Si consideramos
...
Usamos $2^m$ para estimar $n$ pues los máximos se dan cuando se satisface $2^m\approx n$.
...
```{r}
# no. de candidatos del flujo distintos
n <- 1000
