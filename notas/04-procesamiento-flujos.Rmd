...
df <- data_frame(num_distintos = 1:n) %>% # elems distintos
      mutate(id = as.character(sample.int(52345678, n, replace = FALSE))) %>% # muesstreo de datos sin reemplazo
...
Nota: puedes usar la implementación en R que vimos en clase, pero ojo: las funciones hash que utilizamos son relativamente lentas.
